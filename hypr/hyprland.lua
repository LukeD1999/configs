...
hl.bind(mainMod .. " + SHIFT + X", hl.dsp.exec_cmd("ghostty --title='power-menu' --font-size=16 -e ~/.config/waybar/scripts/power-menu.sh"))
...
-- Move tiled windows with keybinds
